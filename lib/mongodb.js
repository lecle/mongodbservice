...
exports.init = function(container, callback) {
    ...
    container.addListener('createIndex', onCreateIndex);

    var mongodbConnectionString = container.getConfig('mongodbConnectionString');
    ...
    onStats({data : {collectionName : 'apps'}}, {send:function(){}, error:function(){}});
...
exports.createIndex = onCreateIndex;
...
function onCreateIndex(req, res) {

    mongodb.createIndex(exports.container, req.data.collectionName, req.data.query, function(err, document) {
