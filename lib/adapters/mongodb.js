...
module.exports.update = function(container, collectionName, find, data, callback) {
    ...
    getCollection(container, collectionName, function(err, collection) {
        ...
        if(find && find.where && find.where._className !== 'aps') {
            verifyData(data);
        }
...
module.exports.createIndex = function(container, collectionName, data, callback) {
    ...
    getCollection(container, collectionName, function(err, collection, db) {
        ...
        container.log.debug('db createIndex');
        collection.createIndex(data, {background:true}, function(err, doc) {
